<html lang="en"><head>
    ...
    <!-- Css animations  -->
    <link rel="stylesheet" href="{{asset('bebas/css/animate.css')}}">
    <link rel="stylesheet" href="{{asset('bebas/css/style.default.css')}}">
    <link rel="stylesheet" href="{{asset('bebas/css/custom.css')}}">

    <!-- Favicon and apple touch icons-->
    <link rel="stylesheet" href="{{asset('bebas/img/favicon.ico')}}">
    <link rel="stylesheet" href="{{asset('bebas/img/apple-touch-icon.png')}}">
    <link rel="stylesheet" href="{{asset('bebas/img/apple-touch-icon-57x57.png')}}">
    <link rel="stylesheet" href="{{asset('bebas/img/apple-touch-icon-72x72.png')}}">
    <link rel="stylesheet" href="{{asset('bebas/img/apple-touch-icon-76x76.png')}}">
    <link rel="stylesheet" href="{{asset('bebas/img/apple-touch-icon-114x114.png')}}">
    <link rel="stylesheet" href="{{asset('bebas/img/apple-touch-icon-120x120.png')}}">
    <link rel="stylesheet" href="{{asset('bebas/img/apple-touch-icon-144x144.png')}}">
    <link rel="stylesheet" href="{{asset('bebas/img/apple-touch-icon-152x152.png')}}">
    <!-- owl carousel css -->
                ...
                <div class="container">
                    ...
                    <div class="row">
                        <div class="col-xs-5 contact">
                            <p class="hidden-sm hidden-xs">aerofood.com</p>
                        ...
                        <div class="navbar-collapse collapse" id="navigation">
                            ...
                            <ul class="nav navbar-nav navbar-right">
                                ...
                                <li class="dropdown use-yamm yamm-fw">
                                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">Job Vaciancies<b class="caret"></b></a>
                                    <ul class="dropdown-menu">
                                        <li>
...
_________________________________________________________ -->
    ...
    <link rel="stylesheet" href="{{asset('bebas/js/jquery.cookie.js')}}">
    <link rel="stylesheet" href="{{asset('bebas/js/waypoints.min.js')}}">
    <link rel="stylesheet" href="{{asset('bebas/js/jquery.counterup.min.js')}}">
    <link rel="stylesheet" href="{{asset('bebas/js/jquery.parallax-1.1.3.js')}}">
    <link rel="stylesheet" href="{{asset('bebas/js/front.js')}}">
  
    

    <!-- owl carousel -->
     <link rel="stylesheet" href="{{asset('bebas/js/owl.carousel.min.js')}}">
